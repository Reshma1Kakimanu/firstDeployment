  ...
  const handleContinue = () => {
    ...
    if (step < 4) {
      ...
      toast({
        ...
        description: `Your appointment with ${serviceData.name} is confirmed for ${selectedDate} at ${selectedTimeSlot}.`,
      });
        ...
        <div className="max-w-3xl mx-auto">
          <div className="glass-card p-6 md:p-8">
            <div className="flex items-center mb-6">
              ...
              <h1 className="text-2xl md:text-3xl font-bold ml-4">{serviceData.name}</h1>
            </div>
                  ...
                  <div>
                    ...
                    <Tabs defaultValue="morning">
                      <TabsList className="w-full mb-4">
                        {serviceData.timeSlots.map((timeSlot) => (
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    ...
                    <div className="p-4 space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{serviceData.subServices.find(s => s.id === selectedSubService)?.name}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-primary">{serviceData.subServices.find(s => s.id === selectedSubService)?.price}</span>
                      </div>
                    </div>
                  </div>
                </div>
